 ...
 <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <li class="nav-item active ">
         <a class="nav-link" href="<?= base_url('ppsu'); ?>">
     ...
     <li class="nav-item">
         <a class="nav-link collapsed" href="<?= base_url('ppsu/profile'); ?>">
             <i class="fas fa-fw fa-user-cog text-gray-100"></i>
             <span class="text-gray-100">Profile</span>
         </a>
     </li>
     ...
     <!-- Nav Item - Pages Collapse Menu -->
     <li class="nav-item">
         <a class="nav-link collapsed" href="<?= base_url('ppsu/laporan'); ?>">
