...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h1 mb-4 text-gray-800">Laporan</h1>
    <hr>
    ...
    <div class="card col-lg">
        <div class="card-body">
            <div class="row">
                ...
                <div class="row col-lg justify-content-end mr-2">
                    <a href="<?= base_url('rptra/tambahlaporan'); ?>" class="col-sm-2 btn btn-primary btn-small">
                        <i class="fas fa-fw fa-plus mr-2"></i>Tambah
                    </a>
                </div>
            </div>
                        ...
                        <?php foreach ($laporan as $lp) :  ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-sm btn-danger" href="<?= base_url('pjlp/deletelaporan/' . $lp['id']); ?>"> <i class="fas fa-fw fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php $i++; ?>
                        <?php endforeach; ?>
