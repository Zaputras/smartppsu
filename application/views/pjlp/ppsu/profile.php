    ...
    <div class="card">
        ...
        <div class="row col-lg-12">
            ...
            <table class="table table-responsive col-lg mt-4">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td width="50%"><?= $user['tempat_lahir']; ?>, <?= $user['tgl_lahir']; ?></td>
                    </tr>
                    <tr>
                        <td width="45%">NIK</td>
                        <td>:</td>
                        <td width="50%"><?= $user['nik']; ?></td>
                    </tr>
                    <tr>
            ...
            <div class="mb-2 d-flex justify-content-end">
                <a href="<?= base_url('ppsu/editprofile'); ?>" class="btn btn-primary"> <i class="fas fa-user-edit mr-2"></i>edit</a>
            </div>
