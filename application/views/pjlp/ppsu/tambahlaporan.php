...
<div class="row justify-content-center container-fluid bg-gradient-primary">
    ...
    <div class="card my-4 col-lg-5">
        <div class="card-body">
            ...
            <!-- <form class="user col-lg-12 m-2" method="post" action="<?= base_url('ppsu/tambahlaporan'); ?>"> -->
            <?php echo form_open_multipart('ppsu/tambahlaporan'); ?>
            ...
            <hr>
            <div class="text-center">
                <a href="<?= base_url('ppsu/laporan'); ?>">Kembali</a>
            </div>
        </div>
