...
<div class="d-flex justify-content-center mt-5">
    <div class="card col-sm-4 border-bottom-success">
        <card class="card-body">
            ...
            <form class="user" method="post" action="<?= base_url('auth/login_admin'); ?>">
                <div class="form-group">
                    <input type="text" class="form-control form-control" id="nopeg" name="nopeg" placeholder="ID Admin" value="<?= set_value('id_pjlp'); ?>">
