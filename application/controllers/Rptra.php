...
class Rptra extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('templates/pjlp/rptra/pjlp_header', $data);
        $this->load->view('templates/pjlp/rptra/pjlp_sidebar', $data);
        $this->load->view('templates/pjlp/rptra/pjlp_topbar', $data);
        $this->load->view('pjlp/rptra/index', $data);
        $this->load->view('templates/pjlp/rptra/pjlp_footer');
    }
    // public function ppsu()
    // {
    //     $data['user'] = $this->db->get_where('users', ['nopeg' =>
    //     $this->session->userdata('nopeg')])->row_array();
    ...
    public function profile()
    {
        ...
        $this->load->view('templates/pjlp/rptra/pjlp_sidebar', $data);
        $this->load->view('templates/pjlp/rptra/pjlp_topbar', $data);
        $this->load->view('pjlp/rptra/profile', $data);
        $this->load->view('templates/pjlp/rptra/pjlp_footer');
    }
    ...
    public function updateProfil()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('templates/pjlp/rptra/pjlp_sidebar', $data);
            $this->load->view('templates/pjlp/rptra/pjlp_topbar', $data);
            $this->load->view('pjlp/rptra/edit_profile', $data);
            $this->load->view('templates/pjlp/rptra/pjlp_footer');
        } else {
            $data = array(
    ...
    public function laporan()
    {
        ...
        $this->load->view('templates/pjlp/rptra/pjlp_sidebar', $data);
        $this->load->view('templates/pjlp/rptra/pjlp_topbar', $data);
        $this->load->view('pjlp/rptra/laporan');
        $this->load->view('templates/pjlp/rptra/pjlp_footer');
    }
    ...
    public function tambahlaporan()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/pjlp/rptra/pjlp_header', $data);
            $this->load->view('pjlp/rptra/tambahlaporan', $data);
            $this->load->view('templates/pjlp/rptra/pjlp_footer');
        } else {
            $data = [
